...
//    @Override
    public boolean delete(PerReplegal replegal) {
     ...
     public List<PerReplegal>findByPerUnidad(PerUnidad unidad){
         ...
         return repLegalRepository.obtenerPorIdPersonaYIdUnidad(unidad.getPerUnidadPK().getIdPersona(), unidad.getPerUnidadPK().getIdUnidad(), new PageRequest(0, 10,sort));
     }
