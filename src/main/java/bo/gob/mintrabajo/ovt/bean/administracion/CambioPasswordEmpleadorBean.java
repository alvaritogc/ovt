...
@ManagedBean
@ViewScoped
public class CambioPasswordEmpleadorBean implements Serializable {
...
public void cambiarContrasenia() {
        ...
        String mensaeje = iUsuarioService.cambiarContraseniaNueva(usuario.getIdUsuario(), contrasenia, contraseniaConfirma);
    ...
    /**
     * @return the contraseniaConfirma
     */
    ...
    /**
     * @param contraseniaConfirma the contraseniaConfirma to set
     */
